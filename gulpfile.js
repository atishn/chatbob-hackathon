...
var tasks = {
  ...
  sass: function() {
    return gulp.src('./client/scss/*.scss')
      ...
      .pipe(postcss([autoprefixer({browsers: ['last 2 versions']}), pxtorem({replace: [true]})]))
...
gulp.task('reload-js', [/*'browserify',*/'copyjs'], function(){
  browserSync.reload();
});
...
gulp.task('copyjs', req, tasks.copyjs);
...
// DEV/WATCH TASK
// --------------------------
gulp.task('watch', ['assets', 'templates', 'sass', 'copyjs',/*'browserify',*/ 'browser-sync'], function() {
